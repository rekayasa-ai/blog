...
// Social Bar component - Loads the Adsterra Social Bar script
// The script renders its own UI (typically in top-right corner)
export function SocialBar({
    ...
    // Inject the Adsterra script when ready
    useEffect(() => {
        if (!shouldLoad || !scriptContainerRef.current) return;
